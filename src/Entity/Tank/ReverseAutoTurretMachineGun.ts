...
export const ReverseAutoTurretMachineGunDefinition: BarrelDefinition = {
    angle: Math.PI,
    offset: 0,
    size: 55,
    width: 42 * 0.7,
 ...
 */
export default class ReverseAutoTurretMachineGun extends ObjectEntity {
    // TODO(ABC):
    ...
    public constructor(owner: BarrelBase, turretDefinition: BarrelDefinition = ReverseAutoTurretMachineGunDefinition, baseSize: number = 25) {
        super(owner.game);
